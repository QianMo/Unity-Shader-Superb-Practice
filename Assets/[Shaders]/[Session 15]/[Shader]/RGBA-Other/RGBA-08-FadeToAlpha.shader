...
Shader "ShaderSuperb/Session15/RGBA-Other/RGBA-08-FadeToAlpha"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag (v2f i) : COLOR
			{
				...
				float4 FadeToAlpha_1 = FadeToAlpha(NewTex_1,_FadeToAlpha_Fade_1);
				float4 FinalResult = FadeToAlpha_1;

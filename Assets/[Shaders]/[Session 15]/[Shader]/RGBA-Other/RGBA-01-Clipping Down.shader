...
Shader "ShaderSuperb/Session15/RGBA-Other/RGBA-01-Clipping Down"
{
	Properties
	{
		[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
		_NewTex_1("NewTex_1(RGB)", 2D) = "white" { }
		_ClippingDown_Value_1("_ClippingDown_Value_1", Range(0, 1)) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag (v2f i) : COLOR
			{
				...
				float4 FinalResult = ClippingDown_1;

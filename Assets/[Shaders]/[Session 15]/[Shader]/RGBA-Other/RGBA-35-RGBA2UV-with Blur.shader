...
Shader "ShaderSuperb/Session15/RGBA-Other/RGBA-35-RGBA2UV-with Blur"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag (v2f i) : COLOR
			{
				...
				float2 rgba_uv_1 = i.texcoord* float2(NewTex_1.r,NewTex_1.g);
				float4 _Blur_1 = Blur(rgba_uv_1,_SourceNewTex_1,_Blur_Intensity_1);

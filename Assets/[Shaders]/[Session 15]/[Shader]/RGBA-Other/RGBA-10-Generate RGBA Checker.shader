...
Shader "ShaderSuperb/Session15/RGBA-Other/RGBA-10-Generate RGBA Checker"
{
	Properties
	{
		...
		_Generate_Checker_Size_1("_Generate_Checker_Size_1", Range(1, 32)) = 5
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				float4 _Generate_Checker_1 = Generate_Checker(i.texcoord,_Generate_Checker_PosX_1,_Generate_Checker_PosY_1,_Generate_Checker_Size_1,0);
				float4 FinalResult = _Generate_Checker_1;

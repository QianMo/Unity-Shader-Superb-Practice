...
Shader "ShaderSuperb/Session15/RGBA-Other/RGBA-11-Generate RGBA Circle"
{
	Properties
	{
		...
		_Generate_Circle_Size_1("_Generate_Circle_Size_1", Range(-1, 1)) = 0.4
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag (v2f i) : COLOR
			{
				...
				float4 FinalResult = _Generate_Circle_1;

...
Shader "ShaderSuperb/Session15/RGBA-FX/04-FX-CircleFade"
{
	Properties
	{
		[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
		_NewTex_1("NewTex_1(RGB)", 2D) = "white" { }
		_CircleFade_PosX_1("_CircleFade_PosX_1", Range(-1, 2)) = 0.4615385
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag (v2f i) : COLOR
			{
				...
				float4 _CircleFade_1 = Circle_Fade(NewTex_1,i.texcoord,_CircleFade_PosX_1,_CircleFade_PosY_1,_CircleFade_Size_1,_CircleFade_Dist_1);

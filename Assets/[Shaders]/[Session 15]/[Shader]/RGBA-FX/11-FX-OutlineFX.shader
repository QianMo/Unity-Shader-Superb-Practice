...
Shader "ShaderSuperb/Session15/RGBA-FX/11-FX-OutlineFX"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 OutLine(float2 uv,sampler2D source, float value, float4 color)
			{
			...
			{
				float4 _Outline_1 = OutLine(i.texcoord,_SourceNewTex_1,_Outline_Size_1,_Outline_Color_1);

...
Shader "ShaderSuperb/Session15/RGBA-FX/10-FX-OutlineEmpty"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				float4 _OutlineEmpty_1 = OutLineEmpty(i.texcoord,_SourceNewTex_1,_OutlineEmpty_Size_1,_OutlineEmpty_Color_1);

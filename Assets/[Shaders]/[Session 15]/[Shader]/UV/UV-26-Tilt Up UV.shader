...
Shader "ShaderSuperb/Session15/UV/UV-26-Tilt Up UV"
{
	Properties
	{
		[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
		TiltUpUV_TiltUpUV_Value_1("TiltUpUV_TiltUpUV_Value_1", Range(-2, 2)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag (v2f i) : COLOR
			{
				...
				float4 NewTex_1 = tex2D(_NewTex_1,TiltUpUV_1);

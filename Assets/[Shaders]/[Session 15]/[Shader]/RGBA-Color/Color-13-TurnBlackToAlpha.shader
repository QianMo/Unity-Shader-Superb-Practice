...
Shader "ShaderSuperb/Session15/RGBA-Color/Color-13-TurnBlackToAlpha"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag (v2f i) : COLOR
			{
				...
				float4 TurnBlackToAlpha_1 = TurnBlackToAlpha(NewTex_1,1,_TurnBlackToAlpha_Fade_1);
				float4 FinalResult = TurnBlackToAlpha_1;

...
Shader "ShaderSuperb/Session15/RGBA-Color/Color-16-TurnTransparentFX"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				float4 _TurnTransparent_1 = ColorTurnTransparent(i.texcoord,_SourceNewTex_1,_TurnTransparent_Speed_1);
				float4 FinalResult = _TurnTransparent_1;

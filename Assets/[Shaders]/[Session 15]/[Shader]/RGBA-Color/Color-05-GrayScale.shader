...
Shader "ShaderSuperb/Session15/RGBA-Color/Color-05-GrayScale"
{
	Properties
	{
		[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
		_NewTex_1("NewTex_1(RGB)", 2D) = "white" { }
		_GrayScale_Fade_1("_GrayScale_Fade_1", Range(0, 1)) = 0.7846152
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag (v2f i) : COLOR
			{
				...
				float4 GrayScale_1 = grayscale(NewTex_1,_GrayScale_Fade_1);

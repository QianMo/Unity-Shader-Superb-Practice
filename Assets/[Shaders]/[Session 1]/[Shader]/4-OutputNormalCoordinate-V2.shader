...
Shader "ShaderSuperb/Session1/4-OutputNormalCoordinate-v2"
{
	Properties
	{
	...
	SubShader
	{
		Pass
		{
			...
			struct v2f
			{
				...
				//COLOR0和COLOR1，可作为顶点和片段的输入输出的语义，是精度低，0–1范围内的数据（如简单的颜色值）可选为1维，二维，三维，四维的float，fixed，half
				float2 normal:COLOR;
			...
			{
				return _factor*float4(i.normal,1,1);
			}

// Reproduces the pattern like on Commodore 64

// Shader source :
// https://pastebin.com/ZQUGyusc
 
// Based on :
// https://thebookofshaders.com/10/
 
// More work about this pattern :
// http://nickm.com/trope_tank/10_PRINT_121114.pdf

Shader "ShaderSuperb/Session19/Noises or Patterns/Noise/10 PRINT CHR$(205.5+RND(1)); : GOTO 10:"
{
	Properties
	{

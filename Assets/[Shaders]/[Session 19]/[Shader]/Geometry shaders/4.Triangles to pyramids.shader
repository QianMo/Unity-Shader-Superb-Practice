// A geometry shader that creates a pyramid for each face (triangle).
// Based on :
// MSDN :https://msdn.microsoft.com/en-us/library/windows/desktop/bb205122(v=vs.85).aspx

Shader "ShaderSuperb/Session19/Geometry/Pyramids"
{
	Properties
	{

...
//Add an outline on a 3D model and fill it with a screenspace texture.
// shader source :
// https://pastebin.com/WfAxEaqP
 
// Model comes from :
// Stick figure

Shader "ShaderSuperb/Session19/Miscellaneous/Outline and ScreenSpace texture"
{
	Properties
	{
		[Header(Outline)]
		_OutlineVal ("Outline value", Range(0., 2.)) = 0.1

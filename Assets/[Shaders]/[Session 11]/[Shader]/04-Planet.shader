// http://wiki.unity3d.com/index.php/Planet
// A shader which adds an atmosphere and shading for one pointlight source to a planet.


// Upgrade NOTE: replaced '_Object2World' with 'unity_ObjectToWorld'
// Upgrade NOTE: replaced 'mul(UNITY_MATRIX_MVP,*)' with 'UnityObjectToClipPos(*)'

Shader "ShaderSuperb/Session11/04-Planet"
{
	Properties
	{

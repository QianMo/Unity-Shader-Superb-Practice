Shader "ShaderSuperb/Session17/Dev/12.SurfaceShaderPBSCookTorranceTranslucency" 
{
	Properties 
	{
    ...
    //Translucency
	//[Space(6)]
	[Header(____________Translucency____________)]
	[Space(6)]
	...
	SubShader 
	{
        ...
        inline float4 LightingCookTorrance (SurfaceOutputCustom s, float3 viewDir, UnityGI gi)
        {
            ...
            //Translucency
			// [GDC 2011 , "Approximating Translucency for a Fast, Cheap and Convincing Subsurface Scattering Look", DICE / Frostbite2]

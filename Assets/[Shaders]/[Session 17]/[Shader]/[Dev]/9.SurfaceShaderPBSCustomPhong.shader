Shader "ShaderSuperb/Session17/Dev/9.SurfaceShaderPBSCustomPhong" 
{
	Properties
	{
	...
	SubShader 
	{
		...
		#pragma surface surf PBS_PhongX fullforwardshadows
		...
		inline fixed4 LightingPBS_PhongX (SurfaceOutput s, half3 viewDir, UnityGI gi)
		{
		...
		inline void LightingPBS_PhongX_GI (SurfaceOutput s, UnityGIInput data, inout UnityGI gi)
		{
